...
def submit_number():
    ...
    client.messages.create(to=formatted_number, from_ = twilio_number, body = "Hi, this is Brian's Twilio test app! Isn't it wonderful?") # Replace body with your message of choice
